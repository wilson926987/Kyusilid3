...
{sidebar && <div className='sidebarcontent'>
 ...
 :
 <ul>
 <li className='sidebarmenu' onClick={()=>{navigate('/kyusilidAdmin'); localStorage.setItem('history', '/home')}}> <div className={`highlight ${isactive('/home') && ' sidebarhighlightactive'}`}></div> <MdSpaceDashboard /> Kyusilid Admin </li>
